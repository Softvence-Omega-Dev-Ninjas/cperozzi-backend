...
var lr = (e, t = new yn()) => {
        ...
        return (
            e.getConnectionInfo && (r.getConnectionInfo = Gl(t, e.getConnectionInfo.bind(e))),
            r
        );
    },
    Jl = (e, t) => ({
...
R.plus = R.add = function (e) {
    ...
    if (((e = new T(e)), !h.d || !e.d))
        return (
            !h.s || !e.s ? (e = new T(NaN)) : h.d || (e = new T(e.d || h.s === e.s ? h : NaN)),
            e
        );
...
function I(e, t, r, n) {
                    ...
                    : l > 5 ||
                      (l == 5 &&
                          (r == 4 ||
                              n ||
                              (r == 6 &&
                                  ((o > 0 ? (s > 0 ? g / W(10, i - s) : 0) : h[T - 1]) % 10) & 1) ||
                              r == (e.s < 0 ? 8 : 7)))),
            t < 1 || !h[0])
        )
            return (
    ...
    return (
        D &&
            (e.e > O.maxE ? ((e.d = null), (e.e = NaN)) : e.e < O.minE && ((e.e = 0), (e.d = [0]))),
        e
    );
}
function Ee(e, t, r) {
